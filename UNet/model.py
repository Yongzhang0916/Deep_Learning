...
def bce_dice_loss(y_true, y_pred):
    ...
    return 0.1*keras.losses.binary_crossentropy(y_true, y_pred) - dice_coef(y_true, y_pred)
    # return keras.losses.binary_crossentropy(y_true, y_pred) - dice_coef(y_true, y_pred)



def unet3D(pretrained_weights=None, input_size=(64,64,32,1)):
    ...
    # model.compile(optimizer=SGD(lr=1e-4), loss=bce_dice_loss, metrics=['accuracy'])
