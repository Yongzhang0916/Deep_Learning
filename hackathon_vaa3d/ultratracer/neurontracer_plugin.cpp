...
//        P.global_name = true;
    ...
    else if (func_name == tr("trace_APP2_GD"))
    {
        ...
        if(inmarker_file.isEmpty())
        {
            ...
            P.markerfilename = inmarker_file;
        cout<<"P.markerfilename: "<<P.markerfilename.toStdString()<<endl;

        //add by yongzhang
        QString allinmarker_file = (paras.size() >= k+1) ? paras[k] : ""; if(allinmarker_file == "NULL") allinmarker_file = ""; k++;
        P.allmarkerfilename = allinmarker_file;
        cout<<"P.allmarkerfilename: "<<P.allmarkerfilename.toStdString()<<endl;
