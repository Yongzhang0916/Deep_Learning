...
def train_model(model, args):
    ...
    checkpoint = callbacks.ModelCheckpoint(args.save_dir + '/trained_model.h5',
                                           monitor='val_loss',
                                           save_best_only=True,
    ...
    # Fitting model
    model.fit(images_train, images_mask_train,
...
if __name__ == "__main__":
    ...
    # python trainOptimization3DUnetPP.py input_images
